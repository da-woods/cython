...
class ModuleNode(Nodes.Node, Nodes.BlockNode):
    ...
    def generate_dealloc_function(self, scope, code):
        ...
        if base_type:
            ...
            # Comment on calls to PyObject_GC_Track below:
            ...
            if tp_dealloc is not None:
                if needs_gc and base_type.scope and base_type.scope.needs_gc():
                    # We know whether the base class uses GC or not
                    code.putln("PyObject_GC_Track(o);")
                ...
                if needs_gc:
                    # we don't know if the base class uses GC or not so must
                    # find it out at runtime
